...
public class AirPodsGen3 {
    ...
    private static final int MASK_CHARGING_LEFT = 1 << 4;
    private static final int MASK_CHARGING_RIGHT = 1 << 5;
    ...
    public static void setModelData(byte[] data) {
        ...
        batteryLeft = (rightLeft == true ? (battery >> 4) : battery) & 0xf;
        batteryRight = (rightLeft == true ? battery : (battery >> 4)) & 0xf;
        chargingLeft = (charging & (rightLeft == true ? MASK_CHARGING_RIGHT : MASK_CHARGING_LEFT)) != 0;
        chargingRight = (charging & (rightLeft == true ? MASK_CHARGING_LEFT : MASK_CHARGING_RIGHT)) != 0;
        ...
        batteryUnified = Math.min((batteryLeft == -1 ? batteryRight : batteryLeft), 
                                  (batteryRight == -1 ? batteryLeft : batteryRight));
    }
